    ...
    public partial class Updates : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagePrivileges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PagePrivileges_Pages_PageId",
                        column: x => x.PageId,
                        principalTable: "Pages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PagePrivileges_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresAdminReset = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagePrivileges_PageId_RoleId",
                table: "PagePrivileges",
                columns: new[] { "PageId", "RoleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PagePrivileges_RoleId",
                table: "PagePrivileges",
                column: "RoleId");
