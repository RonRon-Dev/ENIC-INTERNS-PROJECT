  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        direction === "top"    && "inset-x-0 top-0 h-auto rounded-b-[10px]",
        direction === "right"  && "inset-y-0 right-0 h-full min-w-[400px] rounded-l-[10px] p-4",
        direction === "left"   && "inset-y-0 left-0 h-full min-w-[400px] rounded-r-[10px]",
        className
      )}
