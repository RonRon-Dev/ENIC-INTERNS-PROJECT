...
export default defineConfig({
  ...
  themeConfig: {
        ...
        },
        {
          ...
          items: [
            { text: "Managing Users", link: "/user-manual/managing-users" },
            {
              ...
              link: "/user-manual/roles-privileges",
            },
          ],
        },
      ],
        ...
        },
        {
          ...
          items: [
            { text: "Tech Stack", link: "/technical/tech-stack" },
            {
              ...
              link: "/technical/use-spreadsheet-data",
            },
            {
              text: "Worker Message Protocol",
              link: "/technical/message-protocol",
            },
          ],
        },
      ],
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/RonRon-Dev/ENIC-INTERNS-PROJECT",
      },
    ],
    ...
    editLink: {
      pattern:
        "https://github.com/RonRon-Dev/ENIC-INTERNS-PROJECT/edit/main/frontend/docs/:path",
