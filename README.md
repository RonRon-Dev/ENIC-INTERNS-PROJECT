...
> [!WARNING]
> **Before adding a new migration**, you must **delete all existing files inside the `Migrations/` folder** in the backend project first. Stale migration files will cause conflicts and `database update` will fail.
>
> ```
> backend/
